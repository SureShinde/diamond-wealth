            ...
            parseDatesDraw: function() {
                ...
                if (0 < this.gridCountR)
                    for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle),
                        ...
                        "MM" == A && (g = (p - l) / z,
                        1.5 <= (p - l) / z && (p = p - (g - 1) * z + d.getPeriodDuration("DD", 3),
                        ...
                        if ("radar" == b.type) {
                            ...
                            this.rotate ? "date" == this.type && "middle" == this.gridPosition && (K = -z * this.stepWidth / 2) : "date" == this.type && (g = this.axisWidth - g);
                        f = !1;
        ...
        d.ValueAxis = d.Class({
            ...
            draw: function() {
                ...
                if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)
                    ...
                    !0 === g ? (w = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E,
                        this.stepWidth = this.axisWidth / w,
                    w > this.logGridLimit && (r = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1,
                    ...
                    this.exponential = !1;
                    for (h = t; h < r; h += p) {
                        var A = d.roundTo(this.step * h + this.min, y);
                                ...
                                !this.integersOnly || Math.round(t) == t)
                                    if (isNaN(x) || Number(d.toFixed(t, x)) == t) {
                                        ...
                                        if (t == this.baseValue && "radar" != a.type) {
                                            ...
                                            "H" == this.orientation ? 0 <= f && f <= K + 1 && (D = [f, f, f + k],
                                                C = [H, 0, l]) : 0 <= f && f <= H + 1 && (D = [0, K, K + k],
                                                C = [f, f, f + l]);
                                        ...
                                        if (!isNaN(z) && 0 < A && h < r - 1) {
                                            f = y / z;
                                            g && (z = y * (h + p) + this.minCalc,
                                                z = d.roundTo(z, this.maxDecCount + 1),
                                            w > this.logGridLimit && (z = Math.pow(10, h + p)),
                                                f = 9,
                                                z = (z - t) / f);
                                            K = this.gridAlpha;
                                            this.gridAlpha = this.minorGridAlpha;
                    ...
                    if (0 < B) {
                        ...
                        for (h = this.fillAlpha = 0; h < B; h++)
                            ...
                            isNaN(k - l) || 0 > l && 0 > k || (k = new this.guideFillRenderer(this,l,k,C),
                                ...
                                z = k.graphics(),
                                C.graphics = z,
                            C.balloonText && this.addEventListeners(z, C));
                        this.fillAlpha = D
                    }
                    u = this.baseValue;
        ...
        d.RecItem = d.Class({
            construct: function(a, b, c, e, g, f, h, k, l, m, n, q) {
                ...
                var u = a.axisThickness
                    ...
                    , P = a.labelsEnabled;
                n = a.labelRotationR;
                var ia = a.counter, I = a.inside, aa = a.labelOffset, ma = a.dx, na = a.dy, Pa = a.orientation, Z = a.position, da = a.previousCoord, X = a.height, xa = a.width, ea = a.offset, fa, Ba;
                h ? (void 0 !== h.id && (q = p.classNamePrefix + "-guide-" + h.id),
                    P = !0,
                isNaN(h.tickLength) || (B = h.tickLength),
                void 0 != h.lineColor && (K = h.lineColor),
                ...
                "V" == Pa && (n = 0);
                var ca;
                P && "" !== c && (ca = a.autoWrap && 0 === n ? d.wrappedText(y, c, w, t, r, ga, k, Math.abs(g), 0) : d.text(y, c, w, t, r, ga, k),
                    ga = ca.getBBox(),
                    ha = ga.width,
                    Qa = ga.height);
                if ("H" == Pa) {
                    if (0 <= b && b <= xa + 1 && (0 < B && 0 < z && b + l <= xa + 1 && (fa = d.line(y, [b + l, b + l], [0, B], A, z, C),
                        x.push(fa)),
                    0 < D && (Ba = d.line(y, [b, b + ma, b + ma], [X, X + na, na], K, D, C, H),
                        x.push(Ba))),
                        v = 0,
                        G = b,
                    h && 90 == n && I && (G -= r),
                    ...
                    1 == ia && 0 < M && !h && !m && da < xa && (e = d.fitToBounds(b, 0, xa),
                        ...
                        Y = e - da,
                    0 < Y && (Da = d.rect(y, Y, a.height, Q, M),
                        Da.translate(e - Y + ma, na),
                        x.push(Da))),
                        "bottom" == Z ? (v += X + r / 2 + ea,
                            I ? (0 < n ? (v = X - ha / 2 * Math.sin(V) - B - 3,
                            ...
                            a.centerRotatedLabels || (G += ha / 2 * Math.cos(V))) : v -= B + r + 3 + u + 3,
                                v -= aa)),
                        "bottom" == Z ? Y = (I ? X - B - 1 : X + u - 1) + ea : (oa = ma,
                            Y = (I ? na : na - B - u + 1) - ea),
                    f && (G += f),
                        r = G,
                    ...
                    0 <= b && b <= X + 1 && (0 < B && 0 < z && b + l <= X + 1 && (fa = d.line(y, [0, B + 1], [b + l, b + l], A, z, C),
                        x.push(fa)),
                    0 < D && (Ba = d.line(y, [0, ma, xa + ma], [b, b + na, b + na], K, D, C, H),
                        x.push(Ba)));
                    ga = "end";
                    ...
                    fa && ("right" == Z ? (oa += ma + ea + xa - 1,
                        Y += na,
                        oa = I ? oa - u : oa + u) : (oa -= ea,
                    I || (oa -= B + u)));
                    f && (v += f);
                    I = -3;
                    "right" == Z && (I += na);
                    ca && (v > X + 1 || v < I - r / 10) && (ca.remove(),
                        ca = null)
                }
...
(function() {
        ...
        d.AmGraph = d.Class({
                    ...
                    switch (m) {
                        ...
                        case "inside":
                            "column" == this.type && (l = !0,
                                q ? p ? (k = "end",
                                    b = r - 3 - y) : (k = "start",
                                    b = r + 3 + y) : c = p ? w + 7 + y : w - 10 - y);
                            break;
                        case "middle":
                            "column" == this.type && (l = !0,
                                q ? b -= (b - r) / 2 + y - 3 : c -= (c - w) / 2 + y - 3)
                    }
            ...
            createSerialGraph: function() {
                ...
                V > Da && (V = Da);
                var G, v, oa, ha = q, Qa = n, ca = 0, tb = 0, ub, vb, gb, hb, wb = this.fillColorsR, Ra = this.negativeFillColors, Ja = this.negativeLineColor, Ya = this.fillAlphas, Za = this.negativeFillAlphas;
                ...
                if (!(I || "line" != h && "smoothedLine" != h && "step" != h || (1 == e.length && "step" != h && "none" == this.bullet && (this.bullet = "round",
                    this.resetBullet = !0),
                !Ra && void 0 == Ja || m))) {
                    var Ua = Pa;
                    Ua > f.max && (Ua = f.max);
                ...
                for (L = P; L <= ia; L++) {
                    ...
                    if (m && void 0 == this.openField)
                        for (var yb = L + 1; yb < e.length && (!e[yb] || !(ab = e[L + 1].axes[f.id].graphs[b]) || !ab.values || (Ta = ab.values.value,
                            isNaN(Ta))); yb++)
                            ;
                    var S, R, J, ba, ja = NaN, E = NaN, F = NaN, O = NaN, N = NaN, qa = NaN, ra = NaN, sa = NaN, ta = NaN, ya = NaN, Ea = NaN, ka = NaN, la = NaN, W = NaN, zb = NaN, Ab = NaN, ua = NaN, va = void 0, Na = wb, Va = Ya, Ha = xa, Ca, za, Bb = this.proCandlesticks, mb = this.topRadius, Fa = q - 1, pa = n - 1, bb = this.pattern;
                    ...
                    if (Ia) {
                        ...
                        "center" == this.stepDirection && (nb = Y / 2,
                            ja -= nb);
                        "start" == this.pointPosition && (ja -= Y / 2 + Math.floor(Wa * Y / 2),
                            wa = 0,
                            Ga = Math.floor(Y) + Math.floor(Wa * Y));
                        "end" == this.pointPosition && (ja += Y / 2 + Math.floor(Wa * Y / 2),
                        ...
                        switch (h) {
                            ...
                            case "smoothedLine":
                                if (isNaN(W))
                                    y || (this.drawSmoothedGraph(x, u, T, U),
                                        x = [],
                                        u = [],
                                        T = [],
                                        U = []);
                                    ...
                                    !Ma || isNaN(N) || isNaN(O) || (T.push(O),
                                        U.push(N));
                                    void 0 == v.lineColor && void 0 == v.fillColors && isNaN(v.dashLength) || (this.drawSmoothedGraph(x, u, T, U),
                                        x = [E],
                                        u = [F],
                                        T = [],
                                        U = [],
                                ...
                                if (!isNaN(W)) {
                                    ...
                                    if (!(W < Qb && ob < Qb || W > Rb && ob > Rb)) {
                                        ...
                                        if (t) {
                                            ...
                                            isNaN(G.percentWidthValue) || (J = this.height * G.percentWidthValue / 100,
                                                R = ja - J / 2,
                                                Ea = R + J / 2);
                                            J = d.roundTo(J, 2);
                                            ba = d.roundTo(ba, 2);
                                            R < q && 0 < J && (va = new d.Cuboid(g,ba,J,H - a.d3x,Q - a.d3y,Na,Va,da,Ca,X,ga,w,t,ea,bb,mb,aa),
                                            ...
                                            isNaN(G.percentWidthValue) || (J = this.width * G.percentWidthValue / 100,
                                                S = ja - J / 2,
                                                ya = S + J / 2);
                                            J = d.roundTo(J, 2);
                                            ba = d.roundTo(ba, 2);
                                            S < n + Z * H && 0 < J && (this.showOnAxis && (R -= Q / 2),
                                                va = new d.Cuboid(g,J,ba,H - a.d3x,Q - a.d3y,Na,Va,da,Ca,this.lineAlpha,ga,w,t,ea,bb,mb,aa),
                                    ...
                                    if (va) {
                                        ...
                                        if (!I) {
                                            ...
                                            "3d" == M && (t ? (K = (this.end + 1 - L) * C - c - 1E3 * this.depthCount,
                                                ya += H * Z,
                                                ka += H * Z,
                                                v.y += H * Z) : (K = (C - c) * (L + 1) + 1E3 * this.depthCount,
                                                Ea += Q * Z,
                                                la += Q * Z,
                                                v.y += Q * Z));
                                            if ("regular" == M || "100%" == M)
                                                K = t ? 0 < Ia.value ? (this.end + 1 - L) * C + c : (this.end + 1 - L) * C - c : 0 < Ia.value ? C * L + c : C * L - c;
                                    ...
                                    if (t) {
                                        ...
                                        if (R < q && 0 < J) {
                                            ...
                                            W > ua ? (Eb = [E, sa],
                                                Fb = [O, qa]) : (Eb = [O, sa],
                                                Fb = [E, qa]);
                                            !isNaN(sa) && !isNaN(qa) && F < q && 0 < F && (Xa = d.line(g, Eb, [F, F], Ca, X, da),
                                                cb = d.line(g, Fb, [F, F], Ca, X, da));
                                            ba = E - O;
                                        ...
                                        if (S < n && 0 < J) {
                                            Bb && W >= ua && (Va = 0);
                                            var va = new d.Cuboid(g,J,ba,H,Q,Na,Va,da,Ca,X,ga,w,t,ea,bb,mb,aa), Gb, Hb;
                                            W > ua ? (Gb = [F, ta],
                                                Hb = [N, ra]) : (Gb = [N, ta],
                                                Hb = [F, ra]);
                                            !isNaN(ta) && !isNaN(ra) && E < n && 0 < E && (Xa = d.line(g, [E, E], Gb, Ca, X, da),
                                                cb = d.line(g, [E, E], Hb, Ca, X, da),
                            ...
                            case "ohlc":
                                if (!(isNaN(ua) || isNaN(zb) || isNaN(Ab) || isNaN(W))) {
                                    ...
                                    if (t) {
                                        ...
                                        0 <= O && O <= pa && (qb = d.line(g, [O, O], [Ib, Tb], Ha, X, da, ea));
                                ...
                                if ("regular" == M || "100%" == M) {
                                    ...
                                    if (Zb) {
                                        ...
                                        if (Oa) {
                                            ...
                                            t ? (eb = Ea,
                                                db = 0 > W ? E - ac / 2 - 2 - fb - sb : E + ac / 2 + 3 + fb + sb) : (db = ya,
                                                eb = 0 > W ? F + bc / 2 + fb + sb : F - bc / 2 - 3 - fb - sb);
                                            Oa.translate(db, eb);
                                            f.totals[L] = Oa;
            ...
            drawLineGraph: function(a, b, c, e) {
                ...
                if (1 < a.length) {
                    ...
                    var y = g.negativeLineColor
                        ...
                        , z = g.baseCoord;
                    0 !== g.negativeBase && (z = g.valueAxis.getCoordinate(g.negativeBase, f),
                    z > g.height && (z = g.height),
                    0 > z && (z = 0));
                    ...
                    void 0 === y || g.useNegativeColorIfDown || (p = d.line(l, a, b, y, r, p, x, !1, !0, f),
                ...
                if (1 < a.length) {
                    ...
                    0 < q && (m = a.join(";").split(";"),
                        ...
                        0 < c.length ? (c.push("M"),
                            ...
                            n += " L" + a[0] + "," + x),
                            n += " L" + a[0] + "," + b[0]),
                        c = new d.Bezier(h,m,p,NaN,0,0,t,q,g,n,u),
                        d.setCN(f, c, this.bcn + "fill"),
                        c.path.pattern(this.pattern, NaN, f.path),
                        k.push(c.path),
                    w || void 0 !== r) && (y || (y = q),
                    w || (w = r),
                        a = new d.Bezier(h,a,b,NaN,0,0,w,y,g,n,u),
                    ...
                    if (h && h.enabled && this.showBalloon && !this.hidden) {
                        ...
                        f.rotate && (b = a.y,
                            ...
                            n && h.setBounds(k, l, a + k, q + l),
                                ...
                                h.fixPrevious(),
                            h.fixedPosition && (c = !1),
                                !c && "radar" != f.type && (b < k || b > a + k || g < l - .5 || g > q + l) ? (h.showBalloon(m),
        ...
        d.SimpleChartScrollbar = d.Class({
            ...
            dispatchScrollbarEvent: function() {
                if (this.skipEvent)
                    ...
                    this.getPercents();
                    this.rotate ? (c = e,
                        d = this.height / b) : d = this.width / d;
                    this.fire({
                        type: "zoomed",
                        position: c,
                        chart: a,
            ...
            updateDragIconPositions: function() {
                ...
                this.rotate ? (f = this.dragIconWidth,
                    ...
                    e.translate((k - h) / 2, c - f / 2),
                    d.translate((k - h) / 2, c + a.height - f / 2)) : (f = this.dragIconHeight,
                    h = this.dragIconWidth,
                    e.translate(b - h / 2, (k - f) / 2),
                    d.translate(b - h / 2 + a.width, (k - f) / 2))
            },
            ...
            updateGripCursor: function(a) {
                d.isModern && (a = this.rotate ? a ? this.vResizeCursorDown : this.vResizeCursorHover : a ? this.hResizeCursorDown : this.hResizeCursorHover) && (this.iconRight && this.iconRight.node.setAttribute("style", a),
        ...
        d.ChartScrollbar = d.Class({
            ...
            zoomScrollbar: function(a) {
                if ((!(this.dragging || this.resizingLeft || this.resizingRight || this.animating) || a) && this.dragger && this.enabled) {
                    ...
                    d.parseDates && !d.equalSpacing ? (a = d.stepWidth,
                        c = e.firstTime,
                        b = a * (this.startTime - c),
                        c = a * (this.endTime - c)) : (a[this.start] && (b = a[this.start].x[d.id]),
                    a[this.end] && (c = a[this.end].x[d.id]),
                        a = d.stepWidth,
                    d.startOnAxis || (e = a / 2,
                        b -= e,
                        c += e));
            ...
            draw: function() {
                ...
                if (!isNaN(a)) {
                    ...
                    if (this.show) {
                        ...
                        var K = n.offsetWidth
                            , H = n.offsetHeight;
                        n.clientHeight && (K = n.clientWidth,
                            H = n.clientHeight);
                        A = H + 2 * w;
                        C = K + 2 * r;
                        !isNaN(D) && C < D && (C = D);
                        ...
                        "H" != x ? (D = a - C / 2,
                            ...
                            e && (b += z),
                                ...
                                z = b - A - y,
                                this.deltaSignY = 1)) : (2 * y > A && (y = A / 2),
                            z = b - A / 2,
                            a < h + (l - h) / 2 ? (D = a + y,
                                this.deltaSignX = -1) : (D = a - C - y,
                                this.deltaSignX = 1));
                        z + A >= m && (z = m - A);
                        z < k && (z = k);
                        D < h && (D = h);
                        D + C > l && (D = l - C);
                        var k = z + w, m = D + r, M = this.shadowAlpha, P = this.shadowColor, r = this.borderThickness, ia = this.bulletSize, I, w = this.fillAlpha, aa = this.borderAlpha;
                        this.showBullet && (I = d.circle(g, ia, t, w),
                            f.push(I));
                        this.drop ? (h = C / 1.6,
                            l = 0,
                        "V" == x && (x = "down"),
                        ...
                        "right" == x && (l = 90,
                            ...
                            k = z - H / 2 + 1,
                            m = D - K / 2 - 1,
                            q = d.drop(g, h, l, q, w, r, p, aa)) : 0 < u || 0 === y ? (0 < M && (a = d.rect(g, C, A, q, 0, r + 1, P, M, u),
                            ...
                            h > C - y && (h = C - y),
                            h < y && (h = y),
                                t = [0, h - y, a - D, h + y, C, C, 0, 0],
                                u = Q ? [0, 0, b - z, 0, 0, A, A, 0] : [A, A, b - z, A, A, 0, 0, A]) : (x = b - z,
                            x > A - y && (x = A - y),
                            x < y && (x = y),
                        ...
                        for (Q = 0; Q < g.length; Q++) {
                            ...
                            if (b.valueAxis.id == H) {
                                ...
                                if (!b.connect || b.forceGap && !isNaN(b.gapPeriod))
                                    if (z && z[M] && 0 < P && B.time - w[M] >= y * P && (z[M].gap = !0),
                                        b.forceGap) {
                                        var P = 0, ma;
                                        for (ma in I.values)
                                            P++;
...
(function() {
        ...
        d.TrendLine = d.Class({
            ...
            draw: function() {
                var a = this;
                a.destroy();
                var b = a.chart, c = b.container, e, g, f, h, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory, n = a.finalDate, q = a.finalCategory, p = a.valueAxis, t = a.valueAxisX, r = a.initialXValue, w = a.finalXValue, y = a.initialValue, x = a.finalValue, u = p.recalculateToPercents, A = b.dataDateFormat;
                ...
                p && !u && (isNaN(y) || (f = p.getCoordinate(y)),
...
(function() {
        ...
        d.wedge = function(a, b, c, e, g, f, h, k, l, m, n, q, p, t) {
            ...
            y && (x = r(10 * x),
                ...
                k *= 10,
                w *= 10,
            1 > Math.abs(g) && 1 >= Math.abs(D - z) && 1 >= Math.abs(C - B) && (M = !0));
            g = "";
            var P;
            q && (H["fill-opacity"] = 0,
            ...
            if (0 < l) {
                P = " M" + x + "," + (A + l) + " L" + z + "," + (B + l);
                y ? (M || (P += " A" + (b - f) + "," + (l + c - h) + "," + (b + f) + "," + (l + c + h) + "," + z + "," + (B + l) + "," + D + "," + (C + l)),
                    P += " L" + K + "," + (u + l),
                0 < k && (M || (P += " B" + (b - k) + "," + (l + c - w) + "," + (b + k) + "," + (l + c + w) + "," + K + "," + (l + u) + "," + x + "," + (l + A)))) : (P += " A" + f + "," + h + ",0," + Q + ",1," + D + "," + (C + l) + " L" + K + "," + (u + l),
            ...
            y ? (M || (g = " A" + r(b - f) + "," + r(c - h) + "," + r(b + f) + "," + r(c + h) + "," + r(z) + "," + r(B) + "," + r(D) + "," + r(C)),
                h = " M" + r(x) + "," + r(A) + " L" + r(z) + "," + r(B) + g + " L" + r(K) + "," + r(u)) : h = " M" + x + "," + A + " L" + z + "," + B + (" A" + f + "," + h + ",0," + Q + ",1," + D + "," + C) + " L" + K + "," + u;
...
(function() {
        ...
        d.Bezier = d.Class({
            construct: function(a, b, c, e, g, f, h, k, l, m, n) {
                var q, p;
                "object" == typeof h && 1 < h.length && (p = !0,
                    q = h,
                    h = h[0]);
                ...
                1 < g.length && (b = this.interpolate(g),
        ...
        d.AmLegend = d.Class({
            ...
            arrangeEntries: function() {
                ...
                for (A = 0; A < x.length; A++) {
                    ...
                    u = K.getBBox();
                    var H;
                    this.equalWidths ? H = z * (p + n + this.markerLabelGap) : (H = B,
                        B = B + u.width + f + n);
                    H + u.width > q && 0 < A && 0 !== z && (t++,
                        H = z = 0,
                        B = H + u.width + f + n,
                        D = D + C + m,
                        C = 0);
