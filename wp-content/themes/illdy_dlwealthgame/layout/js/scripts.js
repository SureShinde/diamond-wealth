...
jQuery( document ).ready( function($) {
    ...
    // Add Print Functionality to Front Div
    $("#print_button").on("click", function() {
        //$( '#printGraph' ).printThis();
        $('#header, .container, #static-page-content, .pageLeadin, .explanation, .trexCTA, .bookCTA, .bookLeadin, #latest-news, .wealthSteps, #footer').css('display', 'none');
        window.print();
    });
    (function() {
        ...
        var afterPrint = function() {
            ...
            $('#header, .container, #static-page-content, .pageLeadin, .explanation, .trexCTA, #latest-news, .bookCTA, .bookLeadin, .wealthSteps, #footer').css('display', 'inherit');
        };
    ...
    // Add Save Image Functionality to Front Div
    $(function() { 
        $("#image_button").click(function() { 
            html2canvas($("#printGraph"), {
