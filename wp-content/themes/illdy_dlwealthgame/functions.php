...
if ( ! function_exists( 'illdy_enqueue_stylesheets' ) ) {
	...
	function illdy_enqueue_stylesheets() {
        ...
        if (is_front_page() ){
            wp_enqueue_style( 'export', get_template_directory_uri() . '/layout/css/export.css', array(), '', 'all' );
        }
	}
}
...
if ( ! function_exists( 'illdy_enqueue_javascripts' ) ) {
	...
	function illdy_enqueue_javascripts() {
        ...
        if ( is_front_page() ) { 
            wp_enqueue_script( 'amcharts', get_template_directory_uri() . '/layout/js/amcharts.js', array( 'jquery' ), '1.0.16', true );
            wp_enqueue_script( 'serial', get_template_directory_uri() . '/layout/js/serial.js', array( 'jquery' ), '1.0.16', true );
            wp_enqueue_script( 'export', get_template_directory_uri() . '/layout/js/export.js', array( 'jquery' ), '1.0.16', true );
            wp_enqueue_script( 'html2canvas', get_template_directory_uri() . '/layout/js/html2canvas.js', true );
            wp_enqueue_script( 'html2canvas', get_template_directory_uri() . '/layout/js/canvas2image.js', true );
            wp_enqueue_script( 'custom', get_template_directory_uri() . '/layout/js/custom.js', array( 'jquery' ), '1.0.16', true );
        }
