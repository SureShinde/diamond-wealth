...
$of_options[] = array( 	"name" 		=> "General Settings",
						"desc" 		=> "",
						"id" 		=> "gen_set",
						"std" 		=> "<h3>General Settings</h3>General Settings for the Creativo theme",
						"icon" 		=> true,
						"type" 		=> "info"
				);
...
$of_options[] = array( 	"name" 		=> "Header pos",
						"desc" 		=> "",
						"id" 		=> "header_p",
						"std" 		=> "<h3>Header Position</h3>Select the position of the Header",
						"icon" 		=> true,
						"type" 		=> "info"
				);		
...
$of_options[] = array( 	"name" 		=> "Site Layout",
						...
						"id" 		=> "layout",
						"std" 		=> "<h3>Site Layout</h3>Choose the layout for your website.",
						"icon" 		=> true,
						"type" 		=> "info"
				);
...
$of_options[] = array( 	"name" 		=> "Colors",
						"desc" 		=> "",
						"id" 		=> "header_top",
						"std" 		=> "<h3>Header Top Settings</h3>Use the settings below to Customize the Header Top area",
						"icon" 		=> true,
						"type" 		=> "info"
				);
...
$of_options[] = array( 	"name" 		=> "Header Styling",
						"desc" 		=> "",
						"id" 		=> "header_pos",
						"std" 		=> "<h3 style=\"margin: 0 0 10px;\">Header Styling</h3>Use the options below to alter the design of the Header area.",
						"icon" 		=> true,
						"type" 		=> "info"
				);	
...
$of_options[] = array( 	"name" 		=> "Header Customization",
						"desc" 		=> "",
						"id" 		=> "header_styling",
						"std" 		=> "<h3 style=\"margin: 0 0 10px;\">Header Customization</h3>",
						"icon" 		=> true,
						"type" 		=> "info"
				);
...
$of_options[] = array(  "name" => "Header CTA Button",
...
$of_options[] = array( 	"name" 		=> "Modern Header Styling",
						...
						"std" 		=> "<h3 style=\"margin: 0 0 10px;\">Modern Header Styling</h3>",
						"icon" 		=> true,
						"type" 		=> "info"
				);	
...
$of_options[] = array( 	"name" 		=> "head_lr",
						"desc" 		=> "",
						"id" 		=> "header_left_right",
						"std" 		=> "<h3>Header Left-Right Settings</h3>These settings will work if the Header Left or Header Right options are being used",
						"icon" 		=> true,
						"type" 		=> "info"
				);
...
$of_options[] = array( 	"name" 		=> "footer_sett",
						"desc" 		=> "",
						"id" 		=> "footer_sett",
						"std" 		=> "<h3>Footer Settings</h3>Customize the Footer Section",
						"icon" 		=> true,
						"type" 		=> "info"
				);					
...
$of_options[] = array( 	"name" 		=> "Footer Additional Icons/Images",
						"desc" 		=> "",
						"id" 		=> "ftr2",
						"std" 		=> "<h3 style=\"margin: 0 0 10px;\">Footer Additional Icons/Images</h3>",
						"icon" 		=> true,
						"type" 		=> "info"
				);
...
$of_options[] = array( 	"name" 		=> "cta_bar_button",
						"desc" 		=> "",
						"id" 		=> "cta_bar",
						"std" 		=> "<h3 style=\"margin: 0 0 10px;\">Call to Action Button Text</h3>",
						"icon" 		=> true,
						"fold" => "en_cta",
						"type" 		=> "info"
				);		
...
$of_options[] = array( 	"name" 		=> "blog_sett",
						"desc" 		=> "",
						"id" 		=> "blog_sett",
						"std" 		=> "<h3>Blog Settings</h3>Customize the Blog pages",
						"icon" 		=> true,
						"type" 		=> "info"
				);	
...
$of_options[] = array( 	"name" 		=> "modern-post-title",
						"desc" 		=> "",
						"id" 		=> "modern-post",
						"std" 		=> "<h3 style=\"margin: 0 0 10px;\">Single Post Title - Modern Design layout</h3>
						The following settings will be applied for the Post Title when the Modern option is being selected under Single Post Design.",
						"icon" 		=> true,
						"type" 		=> "info_small"
				);
...
$of_options[] = array( 			
						"std" 		=> "<h3 style=\"margin: 0 0 10px;\">Categories Widget</h3>",
						"icon" 		=> true,
						"type" 		=> "info"
				);
