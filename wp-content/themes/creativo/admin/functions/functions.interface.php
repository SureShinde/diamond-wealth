...
function of_style_only(){
	...
	wp_enqueue_style('simple-line-icons', ADMIN_DIR . 'assets/css/simple-line-icons.css');
	...
	wp_enqueue_style( 'google-open-sans', 'http' . ( ( is_ssl() ) ? 's' : '' ) . '://fonts.googleapis.com/css?family=Open+Sans:400,500,600', '5.7.5' );
