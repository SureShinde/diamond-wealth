		...
		foreach ($options as $value) {
			...
			//Start Heading
			 if ( $value['type'] != "heading" )
			 {
				...
				$output .= '<div class="text_explain ">'."\n";
					if($value['name']) : $output .= '<h3 class="heading">'. $value['name'] .'</h3>'."\n"; endif;

					if(isset($value['desc'])) : $output .= '<div class="explain">'. $value['desc'] .'</div>'."\n"; endif;
					...
					/*if ( $value['type'] != 'heading') { 
						...
						$output .= '<div class="explain_value">'.$explain_value."</div>";					
					}*/
			...
			switch ( $value['type'] ) {
				...
				case "info_small":
					$info_text = $value['std'];
					$output .= '<div class="of-info smaller">'.$info_text.'</div>';
				break;

				case "plain_text":
					$info_text = $value['std'];
					$output .= '<div class="of-info plain_text">'.$info_text.'</div>';
				break;
