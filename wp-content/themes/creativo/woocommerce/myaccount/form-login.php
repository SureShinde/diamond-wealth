...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="form-row">
				...
				<button type="submit" class="woocommerce-Button button button_default small" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>"><?php esc_html_e( 'Login', 'woocommerce' ); ?></button>
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="register">
			...
			<p class="woocommerce-FormRow form-row">
				...
				<button type="submit" class="woocommerce-Button button button_default small" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
			</p>
