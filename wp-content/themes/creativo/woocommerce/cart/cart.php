	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
				...
				<th class="product-quantity"><span class="desktop"><?php _e( 'Quantity', 'woocommerce' ); ?></span><span class="mobile"><?php _e( 'Qty', 'woocommerce' ); ?></span></th>
		...
		<tbody>
			...
			<tr>
				<td colspan="6" class="actions">
					...
					<button type="submit" class="button small button_default" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
...
<div class="cart-collaterals clearfix">
    ...
    <div class="vc_row-fluid">
        ...
        <div class="vc_span6">
        	...
        	<div class="alignright addmargintop"><?php do_action( 'woocommerce_proceed_to_checkout' ); ?></div>
