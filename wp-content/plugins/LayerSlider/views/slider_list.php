		...
		<div class="half">
			<div class="ls-box ls-product-banner ls-auto-update <?php echo  $validity ? 'active' : '' ?>">
				...
				<div class="inner guide">
					<p>
						<?php if( ! $validity ) : ?>
						<p><span style="color: red; font-size:13px; font-weight:bold">IMPORTANT: </span>This plugin comes with a theme. Updates for this plugin will be delivered by the Theme Creators when the theme is being updated! If you want to receive instant updates for this plugin you will have to purchase your own license for LayerSlider.</p>
