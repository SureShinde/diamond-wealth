...
/* Creativo Begin */
vc_lean_map( 'ctitle', null, $vc_config_path . '/creativo/box-title.php' );
vc_lean_map( 'vc_button', null, $vc_config_path . '/creativo/button.php' );
vc_lean_map( 'recent_posts', null, $vc_config_path . '/creativo/posts_grid.php' );
vc_lean_map( 'cr_posts_slider', null, $vc_config_path . '/creativo/posts_slider.php' );
vc_lean_map( 'cr_posts_list', null, $vc_config_path . '/creativo/posts_list.php' );
vc_lean_map( 'vc_portfolio_el', null, $vc_config_path . '/creativo/portfolio_flat.php' );
vc_lean_map( 'recent_works', null, $vc_config_path . '/creativo/portfolio_3d.php' );
...
vc_lean_map( 'vc_carousel2', null, $vc_config_path . '/creativo/owl_carousel.php' );

vc_lean_map( 'vc_product_feature', null, $vc_config_path . '/creativo/product_feature.php' );
vc_lean_map( 'vc_icon', null, $vc_config_path . '/content/shortcode-vc-icon.php' );
vc_lean_map( 'vc_separator', null, $vc_config_path . '/creativo/separator.php' );
vc_lean_map( 'vc_separator_2', null, $vc_config_path . '/creativo/separator_2.php' );
vc_lean_map( 'vc_zigzag', null, $vc_config_path . '/content/shortcode-vc-zigzag.php' );
vc_lean_map( 'vc_testimonials', null, $vc_config_path . '/creativo/testimonials.php' );
vc_lean_map( 'flip_box', null, $vc_config_path . '/creativo/flip_box.php' );
vc_lean_map( 'vc_hoverbox', null, $vc_config_path . '/content/shortcode-vc-hoverbox.php' );
vc_lean_map( 'cr_video_pop', null, $vc_config_path . '/creativo/video_pop.php' );
vc_lean_map( 'gym_classes', null, $vc_config_path . '/creativo/gym.php' );

vc_lean_map( 'vc_employee', null, $vc_config_path . '/creativo/employee.php' );
vc_lean_map( 'vc_clients', null, $vc_config_path . '/creativo/clients.php' );
vc_lean_map( 'tagline_box', null, $vc_config_path . '/creativo/call_action.php' );
vc_lean_map( 'countdown_el', null, $vc_config_path . '/creativo/countdown.php' );
vc_lean_map( 'vc_counter', null, $vc_config_path . '/creativo/counter.php' );
vc_lean_map( 'gmap_advanced', null, $vc_config_path . '/creativo/google_maps.php' );

vc_lean_map( 'social_icons', null, $vc_config_path . '/creativo/social_icons.php' );

vc_lean_map( 'jump_links', null, $vc_config_path . '/creativo/jump_links.php' );
vc_lean_map( 'advanced_tables', null, $vc_config_path . '/creativo/advanced_tables.php' );
if( class_exists('woocommerce')) {
	vc_lean_map( 'woo_carousel', null, $vc_config_path . '/creativo/woo-carousel.php' );
}
vc_lean_map( 'qbox', null, $vc_config_path . '/creativo/qbox.php' );

vc_lean_map( 'vc_service_box', null, $vc_config_path . '/creativo/featured_services.php' );
vc_lean_map( 'vc_price_column', null, $vc_config_path . '/creativo/pricing_column.php' );
vc_lean_map( 'section_separator', null, $vc_config_path . '/creativo/section_separator.php' );
vc_lean_map( 'events_cal', null, $vc_config_path . '/creativo/events.php' );
vc_lean_map( 'restaurant_menu', null, $vc_config_path . '/creativo/restaurant-menu.php' );
/* Creativo end */


vc_lean_map( 'vc_tabs', null, $vc_config_path . '/creativo/tabs.php' );
vc_lean_map( 'vc_tab', null, $vc_config_path . '/creativo/tab.php' );
vc_lean_map( 'vc_tour', null, $vc_config_path . '/creativo/tour.php' );
...
vc_lean_map( 'vc_toggle', null, $vc_config_path . '/content/shortcode-vc-toggle.php' ); // this should use the old toggle styling
...
//Creativo widgets
vc_lean_map( 'vc_contact_us', null, $vc_config_path . '/creativo/widget_contact_us.php' );
vc_lean_map( 'vc_flickr_cr', null, $vc_config_path . '/creativo/widget_flickr.php' );
vc_lean_map( 'vc_recent_portfolio_widget', null, $vc_config_path . '/creativo/widget_recent_portfolio.php' );
vc_lean_map( 'vc_recent_posts_widget', null, $vc_config_path . '/creativo/widget_recent_posts.php' );
vc_lean_map( 'vc_pop_rec_tabs', null, $vc_config_path . '/creativo/widget_recent_posts_tabs.php' );
vc_lean_map( 'vc_twitter_cr', null, $vc_config_path . '/creativo/widget_twitter.php' );
vc_lean_map( 'cr_instagram_widget_render', null, $vc_config_path . '/creativo/widget_cr_instagram.php' );
