	...
	return array(
		...
		'params'=> array(
					...
					array(
						...
						'param_name' => 'emp_design',
						'value' => array( 
							__('Default','Creativo') => 'default', 
							__('Business','Creativo') => 'business' 
						)
			...
			//		  'description' => __('Choose a background color for the employee image when hover', 'Creativo'),
					...
					array(
					  'type' => 'textfield',
					  'heading' => __('Employee Description Padding', 'Creativo'),
					  'param_name' => 'padding_lr',
					  'value' => '',
					  'description' => __('Employee padding left right in pixels', 'Creativo'),
					  'dependency' => array(
							'element' => 'colors',
							'value' => 'custom',
						),
