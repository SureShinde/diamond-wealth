...
return array(
		...
		'params'=> array(
					...
					array(
						'type' => 'dropdown',
						'heading' => __( 'Countdown Alignment', 'js_composer' ),
						...
						'description' => __( 'Select the alignment of the Countdown element.', 'js_composer' ),
						'dependency' => array(
							'element' => 'count_style',
							'value' => 'custom',
						),
					...
					array(
						'type' => 'textfield',
						'heading' => __( 'Countdown Max Width', 'js_composer' ),
						'param_name' => 'count_width',
						'value' => '100%',
						'description' => __( 'Change here the maximum width for the Countdown element. You can enter values in % or px. E.g: 50% or 500px.', 'js_composer' ),
						'dependency' => array(
							'element' => 'count_style',
							'value' => 'custom',
						),
