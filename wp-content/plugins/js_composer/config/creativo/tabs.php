...
*/
	...
	return array(
		...
		'params' => array(
					...
					array(
						'type' => 'textfield',
						'heading' => __( 'Tab Title Font Size', 'js_composer' ),
						'param_name' => 'tt_font_size',
						'value' => '13px',
						'description' => __( 'Font size for the titles of the tabs.', 'js_composer' ),
						'dependency' => array(
							'element' => 'color',
							'value' => 'custom',
						),
					...
					array(
						'type' => 'textfield',
						'heading' => __( 'Tab Title Line Height', 'js_composer' ),
						'param_name' => 'tt_line_height',
						'value' => '40px',
						'description' => __( 'Enter the line height for the title of the tabs.', 'js_composer' ),
						'dependency' => array(
							'element' => 'color',
							'value' => 'custom',
						),
					...
					array(
						'type' => 'dropdown',
						'heading' => __( 'Tab Title Font Weight', 'js_composer' ),
						'param_name' => 'tt_font_weight',
						'value' => array('600','400','500','700','900'),
						'description' => __( 'Select the font weight for the titles of the tabs.', 'js_composer' ),
						'dependency' => array(
							'element' => 'color',
							'value' => 'custom',
						),
					...
					array(
						...
						'value' => array(
							...
							__( 'Design 5', 'js_composer' ) => 'style_5',
						),
					...
					array(
						'type' => 'dropdown',
						'heading' => __( 'Tab Titles Alignment', 'js_composer' ),
						'param_name' => 'tt_alignment',
						'value' => array(
