...
$params = array_merge( array(
        ...
        array(
            'type' => 'colorpicker',            
            'heading' => __('Custom Icon color', 'Creativo'),
            'param_name' => 'custom_icon_color',
            'value' => '', 
            'description' => __('Choose a custom color for the Toggle Icon.', 'Creativo'),
            'dependency' => array(
                'element' => 'style',
                'value' => 'default',
            ),
        ...
        array(
            ...
            'value' => '', 
            'description' => __('Choose a color for the separator. Leave blank to use the default color of the theme.', 'Creativo')
        ),        
        array(
            'type' => 'dropdown',
