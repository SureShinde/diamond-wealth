function carousel_items() {
    jQuery(".clients_carousel").each(function() {
        ...
        var showNav = jQuery(this).attr("show-nav");
...
! function($) {
    vc_iframe.showNoContent = function(show) {
        ...
        if (id && ($el = $("[data-model-id=" + id + "]"))) {
            if (position = $el.offset(), !1 === (position_y = !!position && position.top)) return !1;
            el_height = $el.height(), (position_y > window_scroll_top + window_height || position_y + el_height < window_scroll_top) && $.scrollTo($el, 500, {
                offset: -50
            })
        }
        ...
        var setSectionSortable, setRowSortable, setElementsSortable, $rowSortable, $elementsSortable, _this = this;
        ...
        $main.sortable({
            ...
            start: function(event, ui) {
                vc_iframe.startSorting(), ui.placeholder.height(30), "vc_section" == ui.item.data("tag") ? ($sectionSortables && $sectionSortables.sortable("destroy"), $rowSortable && $rowSortable.sortable("destroy"), $elementsSortable && $elementsSortable.sortable("destroy"), $main.sortable("option", "connectWith", !1), $main.sortable("refresh")) : ($main.sortable("option", "connectWith", ['[data-tag="vc_section"] > .vc_element-container']), $main.sortable("refresh"))
            },
            stop: function(event, ui) {
                _this.stopSorting();
                var tag, vc_map, parent_tag, allowed_container_element, trig_changed, item_model;
                if (tag = ui.item.data("tag"), "vc_section" == tag && (setSectionSortable(), setRowSortable(), setElementsSortable()), $main.sortable("option", "connectWith", !1), $main.sortable("refresh"), vc_map = window.parent.vc.map || !1, parent_tag = ui.item.parents("[data-tag]:first").data("tag"), trig_changed = !0, parent_tag) {
                    allowed_container_element = !vc_map[parent_tag].allowed_container_element || vc_map[parent_tag].allowed_container_element, window.parent.vc.checkRelevance(parent_tag, tag) || (ui.placeholder.removeClass("vc_hidden-placeholder"), $(this).sortable("cancel"), trig_changed = !1);
                ...
                trig_changed && (item_model = parent.vc.shortcodes.get(ui.item.data("modelId")), item_model.view.parentChanged())
            },
            tolerance: "pointer",
            ...
            $elementsSortable = $(".vc_element-container:not(.vc_section)").sortable({
                ...
                stop: function(event, ui) {
                    var item_model, tag = ui.item.data("tag"),
                        ...
                        trig_changed = !0;
                    window.parent.vc.checkRelevance(parent_tag, tag) || (ui.placeholder.removeClass("vc_hidden-placeholder"), $(this).sortable("cancel"), trig_changed = !1), vc_map[tag] === Object(vc_map[tag]) && ((!0 === vc_map[tag].is_container || !1 === vc_map[tag].is_container || "[object Boolean]" === toString.call(vc_map[tag].is_container)) && !0 === vc_map[tag].is_container || null != vc_map[tag].as_parent && "[object Array]" === Object.prototype.toString.call(vc_map[tag].as_parent) && 0 != vc_map[tag].as_parent) && !0 !== allowed_container_element && allowed_container_element !== tag.replace(/_inner$/, "") && (ui.placeholder.removeClass("vc_hidden-placeholder"), $(this).sortable("cancel"), trig_changed = !1), trig_changed && (item_model = parent.vc.shortcodes.get(ui.item.data("modelId")), item_model.view.parentChanged()), vc_iframe.stopSorting()
                }
            })
            ...
            $sectionSortables = $('[data-tag="vc_section"] > .vc_element-container').sortable({
                ...
                stop: function(event, ui) {
                    var tag, vc_map, parent_tag, allowed_container_element, trig_changed, item_model;
                    if (tag = ui.item.data("tag"), vc_map = window.parent.vc.map || !1, parent_tag = ui.item.parents("[data-tag]:first").data("tag"), trig_changed = !0, parent_tag) {
                        allowed_container_element = !vc_map[parent_tag].allowed_container_element || vc_map[parent_tag].allowed_container_element, window.parent.vc.checkRelevance(parent_tag, tag) || (ui.placeholder.removeClass("vc_hidden-placeholder"), $(this).sortable("cancel"), trig_changed = !1);
                        vc_map[tag] === Object(vc_map[tag]) && ((!0 === vc_map[tag].is_container || !1 === vc_map[tag].is_container || "[object Boolean]" === toString.call(vc_map[tag].is_container)) && !0 === vc_map[tag].is_container || null != vc_map[tag].as_parent && "[object Array]" === Object.prototype.toString.call(vc_map[tag].as_parent) && 0 != vc_map[tag].as_parent) && !0 !== allowed_container_element && allowed_container_element !== tag.replace(/_inner$/, "") && (ui.placeholder.removeClass("vc_hidden-placeholder"), $(this).sortable("cancel"), trig_changed = !1)
                    }
                    trig_changed && (item_model = parent.vc.shortcodes.get(ui.item.data("modelId")), item_model.view.parentChanged()), _this.stopSorting()
                },
                tolerance: "pointer",
                update: function(event, ui) {
                    parent.vc.app.saveRowOrder(event, ui)
        ...
        }, setSectionSortable(), setElementsSortable(), setRowSortable(), $main.disableSelection(), $main.delegate("select", "mouseenter", function() {
        ...
        if (src.match(/load\-scripts\.php/)) {
            scripts_string = src.match(/load%5B%5D=([^&]+)/)[1], scripts_string && (scripts = scripts_string.split(","));
        ...
        return !vc_iframe.loaded_script[window.parent.vc_globalHashCode(src)] && (vc_iframe.loaded_script[window.parent.vc_globalHashCode(src)] = src, src)
        ...
        return this.activities_list = [], window.setTimeout(function() {
            window.vc_teaserGrid(), window.vc_carouselBehaviour(), window.vc_prettyPhoto(), window.vc_googleplus(), window.vc_pinterest(), window.vc_progress_bar(), window.vc_rowBehaviour(), window.vc_waypoints(), window.vc_google_fonts(), window.vc_gridBehaviour(), window.vc_googleMapsPointer(), $(window).trigger("vc_reload"), $(window).trigger("resize")
        }, 10), !0
        ...
        if (!vc_iframe.scripts_to_wait || !vc_iframe.scripts_to_load) return void vc_iframe.reload();
        ...
        $el.each(function(index) {
            var $this = $(this),
                ...
                active_tab = ($this.attr("data-interval"), !isNaN($this.data("active-tab")) && 0 < parseInt($this.data("active-tab")) && parseInt($this.data("active-tab")) - 1),
        ...
        if (!$gallery.find("img:first").prop("complete")) return void window.setTimeout(function() {
        ...
        window.vc_pieChart(), window.setTimeout(function() {
        ...
        }, vc_iframe.gmap_advanced = function(model_id) {
            var $el = $("[data-model-id=" + model_id + "]");
            $(".googlemaps").each(function() {
                ...
                popSize && (popSize = 'style="width:' + popSize + ';"'), messageEl && (messageEl = "<p>" + messageEl + "</p>"), titleEl && (titleEl = "<h3>" + titleEl + "</h3>");
            ...
            var $el = $("[data-model-id=" +
                model_id + "]");
            carousel_items()
        }, vc_iframe.vc_testimonials = function(model_id) {
            var $el = $("[data-model-id=" + model_id + "]");
            carousel_items()
        }, vc_iframe.woo_carousel = function(model_id) {
            var $el = $("[data-model-id=" + model_id + "]");
            carousel_items()
        ...
        }, vc_iframe.cr_posts_slider = function(model_id) {
            var $el = $("[data-model-id=" + model_id + "]");
            cr_flexslider_masonry()
