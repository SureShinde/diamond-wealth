        ...
        function fullWidthRow() {
            ...
            $.each($elements, function(key, item) {
                ...
                if ($el_full.length || ($el_full = $el.parent().next(".vc_row-full-width")), $el_full.length) {
                    $container_pos !=  "top" ? $container_margin_offset = $container_pos == "right" ? 0 : $container_margin : $container_margin_offset = 0, $container_margin = $(window).width() > 768 ? $container_margin : 0;
                    var el_margin_left = parseInt($el.css("margin-left"), 10),
                        el_margin_right = parseInt($el.css("margin-right"), 10),
                        offset = $(window).width() > 768 ? $container_margin_offset - $el_full.offset().left - el_margin_left : -el_margin_left,
