 ...
 */
$el_class = $full_height = $parallax_speed_bg = $parallax_speed_video = $full_width = $equal_height = $flex_row = $columns_placement = $content_placement = $parallax = $parallax_image = $css = $el_id = $video_bg = $video_bg_url = $video_bg_parallax = $css_animation = $video_bg_render = '';
$disable_element = '';
$output = $after_output = '';
...
if ( ! empty( $full_width ) ) {
	...
	if( 'normal_no_spaces' === $full_width ) {
...
if ( ! empty( $parallax ) ) {
	$parallax_sizing = isset($parallax_sizing) ? $parallax_sizing : 'cover';
	$wrapper_attributes[] = 'data-stellar-background-ratio="0.5" style="background-size: ' . $parallax_sizing . '; background-attachment:fixed;"';
	$css_classes[] = 'parallax_class';
}
/*
if ( ! empty( $parallax ) ) {
	...
	if ( false !== strpos( $parallax_type, 'fade' ) ) {
		$css_classes[] = 'js-vc_parallax-o-fade';
		$wrapper_attributes[] = 'data-vc-parallax-o-fade="on"';
	} elseif ( false !== strpos( $parallax_type, 'fixed' ) ) {
