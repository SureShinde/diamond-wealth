 ...
 */
$thumbnail = '';
$title = $source = $type = $onclick = $custom_links = $custom_links_target = $img_size = $external_img_size = $images = $custom_srcs = $el_class = $el_id = $interval = $css = $css_animation = $custom_width = '';
$large_img_src = '';
...
$output = '';
$output .= '<div class="' . $css_class . '" '.$custom_width. ' ' . implode( ' ', $wrapper_attributes ) . '>';
