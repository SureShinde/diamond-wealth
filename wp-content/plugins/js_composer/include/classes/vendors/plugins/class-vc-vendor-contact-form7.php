	...
	public function addShortcodeSettings( $tag ) {
		...
		return array(
			...
			'params' => array(
				...
				array(
					'type' => 'dropdown',
					'heading' => __( 'Form Layout', 'js_composer' ),
					'param_name' => 'layout',
					'value' => array(
							__( 'Full width', 'js_composer' ) => 'full',
							__( '2 Columns', 'js_composer' ) => 'half',
							__( '3 Columns', 'js_composer' ) => 'third',
							__( '4 Columns', 'js_composer' ) => 'fourth'
						),					
					'description' => __( 'Choose the layout for the fields inside the form.', 'js_composer' ),
					'dependency' => array(
						'element' => 'style',
						'value' => 'custom',
					),					
				...
				array(
					'type' => 'dropdown',
					'heading' => __( 'Force last element Full Width', 'js_composer' ),
					'param_name' => 'last_el_fw',
					'value' => array( 
						__('No','Creativo') => 'no', 
						__('Yes','Creativo') => 'yes' 
					),
					'description' => __( 'Forces the last element of the contact form to be full width - useful if you want the Textarea to appear on a single row.', 'js_composer' ),
					'dependency' => array(
						'element' => 'style',
						'value' => 'custom',
					),				
				...
				array(
					'type' => 'textfield',
					'heading' => __( 'Submit Button Top Margin', 'js_composer' ),
					...
					'description' => __( 'Enter a value for the Margin Top of the button. Default is: 10px', 'js_composer' )
				),
				array(
					'type' => 'dropdown',
					'heading' => __( 'Submit Button Text Alignment', 'js_composer' ),
					'param_name' => 'btn_text_algin',
					'value' => array( 
						__('Left','Creativo') => 'left', 
						__('Center','Creativo') => 'center',
						__('Right','Creativo') => 'right'
					),
					'dependency' => array(
						'element' => 'style',
						'value' => 'custom',
				...
				array(
					'type' => 'dropdown',
					'heading' => __( 'Submit Button Positioning', 'js_composer' ),
					'param_name' => 'btn_pos',
					'value' => array( 
						__('Left','Creativo') => 'left', 
						__('Center','Creativo') => 'center',
				...
				array(
					'type' => 'dropdown',
					'heading' => __( 'Display Inline Button', 'js_composer' ),
					...
					'description' => 'Should only be used if the form has only one field and one button - SUBSCRIBE to Newsletter example. Will not work for multiple fields!'
				),
				array(
					'type' => 'textfield',
					'heading' => __( 'Contact Form Width', 'js_composer' ),
					'param_name' => 'contact_form_width',
					'value' => '100%',
					'dependency' => array(
						'element' => 'style',
						'value' => 'custom',
					),					
					'description' => __( 'Optionally you can enter a manual width for the contact form. Try using percent values: 70%', 'js_composer' )
				),
