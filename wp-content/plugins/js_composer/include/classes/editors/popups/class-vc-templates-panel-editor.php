...
HTML;
	...
	public function getAllTemplates() {
		...
		if ( ! empty( $default_templates ) ) {
			$arr_category = array(
				...
				'category_name' => __( 'Creativo Blocks', 'js_composer' ),
				'category_description' => __( 'Append predefined Creativo templates to the current layout.', 'js_composer' ),
				'category_weight' => 11,
				/*creativo addition end*/
			);
			$category_templates = array();
	...
	public function renderTemplateListItem( $template ) {
		...
		/*creativo addition - adding in preview img*/
...
HTML;
	...
	if(!empty($preview_img) && $template_type == 'default_templates') $output .= '<div class="img-wrap"><img src="'.$preview_img.'" alt="'.$name.'" width="300" height="200" /></div>';
